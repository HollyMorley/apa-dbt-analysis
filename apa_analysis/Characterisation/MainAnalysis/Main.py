"""Main characterisation pipeline running PCA, regression, feature clustering, and cross-validation."""
import os
import itertools
import random
import pickle
...
from apa_analysis.Characterisation import SingleFeaturePred_utils as sfpu
from apa_analysis.Characterisation import MultiFeaturePred_utils as mfpu
from apa_analysis.Characterisation.AnalysisTools import ClusterFeatures as cf
from apa_analysis.Characterisation.AnalysisTools import PCA as pca
from apa_analysis.Characterisation.AnalysisTools import Regression as reg
from apa_analysis.Characterisation.Plotting import ClusterFeatures_plotting as cfp
from apa_analysis.Characterisation.Plotting import SingleFeaturePred_plotting as sfpp
from apa_analysis.Characterisation.Plotting import PCA_plotting as pcap
from apa_analysis.Characterisation.Plotting import Regression_plotting as regp
...
base_save_dir_no_c = r"H:\Characterisation_v2\\LH_corrections"
...
def main(stride_numbers: List[int], phases: List[str],
    ...
    # Force global_settings['pcs_to_use'] to be 3
    global_settings['pcs_to_use'] = 3
    ...
    #
    _ = regp.plot_aggregated_run_predictions(pca_pred_top3, MultiTopPCsPath, phases[0], phases[1], -1, condition, smooth_kernel=3, error_bars=True)
